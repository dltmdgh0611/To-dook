...
export const translations = {
  ko: {
    ...
    // 추천인
    referral: '친구 초대',
    referralDesc: '친구를 초대하고 혜택을 받으세요!',
    myReferralCode: '나의 초대 코드',
    referralCodeCopied: '초대 코드가 복사되었습니다!',
    referralCount: '초대한 친구',
    referralCountUnit: '명',
    referralBenefit: '친구 초대 혜택',
    referralBenefitDesc: '친구가 가입하면 나와 친구 모두에게 혜택이 주어집니다.',
    enterReferralCode: '초대 코드 입력 (선택)',
    referralCodePlaceholder: '초대 코드가 있다면 입력하세요',
    referralCodeOptional: '초대 코드가 없어도 시작할 수 있어요',
  ...
  en: {
    ...
    referralDesc: 'Invite friends and get rewards!',
    myReferralCode: 'My Invite Code',
    referralCodeCopied: 'Invite code copied!',
    referralCount: 'Friends Invited',
    referralCountUnit: '',
    referralBenefit: 'Referral Benefits',
    referralBenefitDesc: 'Both you and your friend get rewards when they sign up.',
    enterReferralCode: 'Enter invite code (optional)',
    referralCodePlaceholder: 'Enter invite code if you have one',
    referralCodeOptional: 'You can start without an invite code',
    step4of4: 'Step 4 of 4',
    copyCode: 'Copy Code',
  }
};
